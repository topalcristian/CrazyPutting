...
import com.crazy_putting.game.FormulaParser.Function2d;
...
public class Course {
    ...
    public Function2d get_height(String height) {
        return new HeightSolver(height);
    }

    public double heightEval(Function2d func, double x, double y) {
        return func.evaluate(new Vector2D(x, y));
    }
