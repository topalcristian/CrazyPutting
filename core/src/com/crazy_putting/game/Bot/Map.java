    ...
    public boolean lineOfSight(int x1, int y1, int x2, int y2) {
        ...
        if (dx > dy) {
            while (x1 != x2) {
                f += dy;
                if (f >= dx) {
                    if (nodes[x1 + ((sx - 1) / 2)][y1 + ((sy - 1) / 2)].isWalkable() == false) {
                        return false;
                    }
                    y1 += sy;
                    f -= dx;
                }
                if (f != 0 && nodes[x1 + ((sx - 1) / 2)][y1 + ((sy - 1) / 2)].isWalkable() == false) {
                    return false;
                }
                if (dy == 0 && nodes[x1 + ((sx - 1) / 2)][y1].isWalkable() == false && nodes[x1 + ((sx - 1) / 2)][y1 - 1].isWalkable() == false) {
                    return false;
                }
                x1 += sx;
            }
            ...
            while (y1 != y2) {
                ...
                if (dx == 0 && nodes[x1][y1 + ((sy - 1) / 2)].isWalkable() == false && nodes[x1 - 1][y1 + ((sy - 1) / 2)].isWalkable() == false) {
                    return false;
                }
                y1 += sy;
            }
    ...
    public boolean botLineOfSight(int x1, int y1, int x2, int y2) {
        ...
        if (dx > dy) {
            while (x1 != x2) {
                f += dy;
                if (f >= dx) {
                    if (nodes[x1 + ((sx - 1) / 2) + 1000][y1 + ((sy - 1) / 2) + 1000].isWalkable() == false) {
                        return false;
                    }
                    y1 += sy;
                    f -= dx;
                }
                if (f != 0 && nodes[x1 + ((sx - 1) / 2) + 1000][y1 + ((sy - 1) / 2) + 1000].isWalkable() == false) {
                    return false;
                }
                if (dy == 0 && nodes[x1 + ((sx - 1) / 2) + 1000][y1 + 1000].isWalkable() == false && nodes[x1 + ((sx - 1) / 2) + 1000][y1 - 1 + 1000].isWalkable() == false) {
                    return false;
                }
                x1 += sx;
            }
            ...
            while (y1 != y2) {
                ...
                if (dx == 0 && nodes[x1 + 1000][y1 + ((sy - 1) / 2) + 1000].isWalkable() == false && nodes[x1 - 1 + 1000][y1 + ((sy - 1) / 2) + 1000].isWalkable() == false) {
                    return false;
                }
                y1 += sy;
            }
